describe('Controller: AssignmentCtrl', function() {
  var scope, AssignmentCtrl, routeParams, httpBackend;
  ...
  beforeEach(inject(function($rootScope, $controller, $httpBackend, $http) {
    ...
    AssignmentCtrl = $controller('AssignmentCtrl', {$scope: scope,
                                                    $routeParams: routeParams,
                                                    $http: $http}); 
    httpBackend.flush();
  }));

  it('should have AssignmentCtrl', function() {
    expect(AssignmentCtrl).not.toBeNull();
  });
